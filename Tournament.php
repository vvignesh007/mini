...
?>
        ...
        <div class="in_header">
            <div class="logo">
                <h1>TOURNAMENTS</h1>
                <!-- <marquee direction="">TOURNAMENT</marquee> -->
            </div>
        </div>
    </div>
       ...
       <div class="imgBx">
        ...
        <div class="content">
            ...
            <h2>DATE : <a><?php echo $res['date']?></a> </h2>
             ...
             <!-- <button type="submit"  name="booknow" class="utton" style="margin-top: 5px;"><a href="booking.php?id=<?php echo $res;?>">register</a></button>  -->
        </div>
    </div></form></li>
    <?php
        }
